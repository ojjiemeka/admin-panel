    ...
    <div class="topnav">
      <div class="container-fluid">
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
          <div
            class="collapse justify-content-evenly navbar-collapse"
            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                  <a href="index.html" class="dropdown-item" key="t-default">
                    Default
                  </a>
                  <a
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  <span key="t-apps">Apps</span> <div class="arrow-down"></div>
                </a>
                <div class="dropdown-menu" aria-labelledby="topnav-pages">
                  ...
                  <a href="chat.html" class="dropdown-item" key="t-chat">
                    Chat
                  </a>
                  <a
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="topnav-crypto">
                      ...
                      <a
                        href="crypto-lending.html"
                        class="dropdown-item"
                        key="t-lending">
                        Lending
                      </a>
                      <a
                        href="crypto-orders.html"
                        class="dropdown-item"
                        key="t-orders">
                        Orders
                      </a>
                      <a
                        href="crypto-kyc-application.html"
                        class="dropdown-item"
                        key="t-kyc">
                        KYC Application
                      </a>
                      <a
                        href="crypto-ico-landing.html"
                        class="dropdown-item"
                        key="t-ico">
                        ICO Landing
                      </a>
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="topnav-jobs">
                      ...
                      <div class="dropdown">
                        ...
                        <div
                          class="dropdown-menu"
                          aria-labelledby="topnav-candidate">
                          <a
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  <span key="t-components">Components</span>{" "}
                  <div class="arrow-down"></div>
                </a>
              ...
              <li class="nav-item dropdown">
                <a
                  ...
                  <span key="t-extra-pages">Extra pages</span>{" "}
                  <div class="arrow-down"></div>
                </a>
